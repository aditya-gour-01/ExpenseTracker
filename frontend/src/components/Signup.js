...
const Signup=()=>{
    ...
    const handleChange=(e)=>{
        setFormData({...formData,[e.target.name]:e.target.value}); ///...fromData to persist the previous value we set in the form field say we you add name then email then we want the name to be also included in the state variable 
    };
    ...
    return(
        <div className='container mt-5'>
            <div className='text-center mb-4'>
                ...
                <p className='text-muted'>Create your account to start the expense management system</p>
            </div>
            ...
            <button type="submit" className='btn btn-primary w-100 mt-3'><i className='fas fa-user-plus me-2'></i>Submit</button>
            </form>
            <ToastContainer/>
        </div>
    )
